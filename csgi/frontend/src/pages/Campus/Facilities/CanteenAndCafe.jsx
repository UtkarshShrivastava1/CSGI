  ...
  return (
    <div className="max-w-4xl mx-auto p-6 font-sans">
      <div className="bg-[#0d173b] text-white p-6">
        <h1 className="text-3xl font-bold">Canteen & Cafe</h1>
      ...
      <div className="bg-white rounded-b-lg shadow-lg overflow-hidden mb-8">
        <div className="p-4 bg-blue-50 border-b border-blue-100">
          <h2 className="text-xl font-bold text-blue-900">Canteen / Cafeteria</h2>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-[#0d173b] flex-1 min-w-48 shadow-sm">
