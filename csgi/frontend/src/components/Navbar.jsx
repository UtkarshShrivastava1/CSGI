              ...
              <div className="hidden group-hover:block absolute z-20 top-full pt-2 w-56">
                ...
                <div className="rounded-md shadow-lg bg-white">
                  <div className="py-1">
                    ...
                    <Link to="/naac-cycle/AQAR" className="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100">AQAR</Link>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div>
              ...
              >
                About
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdownMobile === 1 ? 'rotate-180' : ''}`} />
              </button>

              {activeDropdownMobile === 1 && (
                <div className="pl-4 space-y-1 mt-1">
                  <Link to="/introduction" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Introduction
                  </Link>
                  <Link to="/society" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Society
                  </Link>
                  <Link to="/aspiration" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Aspiration
                  </Link>
                  <Link to="/achievement" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Achievement
                  </Link>
                  <Link to="/professional-bodies" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Professional Bodies
                  </Link>
                  <Link to="/message" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Message
                  </Link>
                  <Link to="/governing-body" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Governing Body
                  </Link>
                  <Link to="/celebration" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Celebration
                  </Link>
                </div>
              )}
            ...
            <div>
              ...
              >
                Academics
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdownMobile === 2 ? 'rotate-180' : ''}`} />
              </button>
            ...
            <div>
              ...
              >
                Admission
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdownMobile === 3 ? 'rotate-180' : ''}`} />
              </button>

              {activeDropdownMobile === 3 && (
                <div className="pl-4 space-y-1 mt-1">
                  <Link to="/courses-offered" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Courses Offered
                  </Link>
                  <Link to="/admission-process" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Admission Process
                  </Link>
                  <Link to="/help-desk" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Help Desk
                  </Link>
                  <Link to="/leaflet" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Leaflet
                  </Link>
                </div>
              )}
            ...
            <div>
              ...
              >
                Campus
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdownMobile === 4 ? 'rotate-180' : ''}`} />
              </button>

              {activeDropdownMobile === 4 && (
                <div className="pl-4 space-y-1 mt-1">
                  <Link to="/facilities" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Facilities
                  </Link>
                  <Link to="/initiatives" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Initiatives
                  </Link>
                </div>
              )}
            ...
            <div>
              ...
              >
                Placement
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdownMobile === 6 ? 'rotate-180' : ''}`} />
              </button>

              {activeDropdownMobile === 6 && (
                <div className="pl-4 space-y-1 mt-1">
                  <Link to="/about-tnp-cell" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    About TNP Cell
                  </Link>
                  <Link to="/internship" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Internship
                  </Link>
                  <Link to="/mous" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    MOUs
                  </Link>
                  <Link to="/our-recruiters" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Our Recruiters
                  </Link>
                  <Link to="/placement-policies" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Placement Policies
                  </Link>
                  <Link to="/team-members" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Team Members
                  </Link>
                  <Link to="/placement-statistics" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Placement Statistics
                  </Link>
                  <Link to="/training-programme" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Training Programme
                  </Link>
                </div>
              )}
            ...
            <div>
              ...
              >
                Alumni
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdownMobile === 7 ? 'rotate-180' : ''}`} />
              </button>
              ...
              {activeDropdownMobile === 7 && (
                <div className="pl-4 space-y-1 mt-1">
                  ...
                  <Link to="/presence" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Presence
                  </Link>
                  <Link to="/registered-association" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
            ...
            <div>
              ...
              >
                NAAC Cycle
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdownMobile === 8 ? 'rotate-180' : ''}`} />
              </button>

              {activeDropdownMobile === 8 && (
                <div className="pl-4 space-y-1 mt-1">
                  <Link to="/naac-cycle/naac-cycle-1" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    NAAC Cycle 1
                  </Link>
                  <Link to="/naac-cycle/naac-cycle-2" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    NAAC Cycle 2
                  </Link>
                  <Link to="/naac-cycle/naac-cycle-3" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    NAAC Cycle 3
                  </Link>
                  <Link to="/naac-cycle/AQAR" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    AQAR
                  </Link>
                </div>
              )}
            ...
            <div>
              ...
              >
                More
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdownMobile === 9 ? 'rotate-180' : ''}`} />
              </button>

              {activeDropdownMobile === 9 && (
                <div className="pl-4 space-y-1 mt-1">
                  <Link to="/student-affairs" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Student Affairs
                  </Link>
                  <Link to="/r-and-d" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    R&D
                  </Link>
                  <Link to="/calendar" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Calendar
                  </Link>
                  <Link to="/feedback" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Feedback
                  </Link>
                  <Link to="/gallery" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Gallery
                  </Link>
                  <Link to="/grievances" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    Grievances
                  </Link>
                  <Link to="/iqac" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    IQAC
                  </Link>
                  <Link to="/rti" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    RTI
                  </Link>
                </div>
              )}
