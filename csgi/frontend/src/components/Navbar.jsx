          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div>
              ...
              {activeDropdownMobile === 8 && (
                <div className="pl-4 space-y-1 mt-1">
                  <Link to="/naac-cycle-1" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    NAAC Cycle 1
                  </Link>
                  <Link to="/naac-cycle-2" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    NAAC Cycle 2
                  </Link>
                  <Link to="/naac-cycle-3" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#1a2d5e] hover:text-white" onClick={() => setMobileMenuOpen(false)}>
                    NAAC Cycle 3
                  </Link>
                </div>
              )}
