        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about" className="text-gray-300 hover:text-blue-300 transition duration-300 inline-block py-1">About CSIT</Link></li>
              <li><Link href="/more/student-affairs" className="text-gray-300 hover:text-blue-300 transition duration-300 inline-block py-1">Students Associations</Link></li>
              <li><Link href="/more/student-affairs" className="text-gray-300 hover:text-blue-300 transition duration-300 inline-block py-1">Industrial Visit</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/funds" className="text-gray-300 hover:text-blue-300 transition duration-300 inline-block py-1">FUNDS & GRANTS</Link></li>
            </ul>
          </div>
